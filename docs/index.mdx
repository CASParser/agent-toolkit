---
title: Introduction
description: The portfolio import API for Indian fintech. Parse CAS PDFs, fetch holdings via OTP, import from email. 9 asset classes. 5-minute integration.
---
...
Parse any CAS PDF, fetch live holdings via CDSL OTP, or import directly from email (Gmail, Outlook, Zoho) — all through one API with **99.9% uptime**.
...
<CardGroup cols={2}>
  ...
  <Card title="Email Inbox Import" icon="envelope" href="/guides/gmail-inbox">
    Import CAS files from Gmail, Outlook, or Zoho
  </Card>

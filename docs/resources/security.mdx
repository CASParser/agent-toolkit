...
| Feature | Details |
|---------|---------|
| **Hosting** | India-based infrastructure (AWS Mumbai) |
...
<Card title="Contact Support" icon="envelope" href="mailto:sameer@casparser.in">
  Email sameer@casparser.in for security questions
</Card>

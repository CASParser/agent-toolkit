...
| CAS Type | Password |
|----------|----------|
| **CDSL eCAS** | Your PAN number |
| **NSDL eCAS** | Your PAN number |
...
<Accordion title="Can I import CAS from email?">
Yes. The **Email Inbox Import** feature uses OAuth to import CAS files directly from a user's inbox. Supports Gmail, Outlook, and Zoho.

[Email Import guide](/guides/gmail-inbox)
</Accordion>
...
- No data retention after parsing
- User consent required for email OAuth

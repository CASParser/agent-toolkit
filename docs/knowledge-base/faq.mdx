...
We offer a 7-day money-back guarantee for annual plans. Monthly plans are non-refundable.
</Accordion>
...
| KFintech generation | 5-15 minutes (async) |
</Accordion>
...
- India-hosted infrastructure (AWS Mumbai)
...
The CAS is emailed to the user within 5-15 minutes.
...
- **Email:** [sameer@casparser.in](mailto:sameer@casparser.in) (< 24hr response)
...
Email [sameer@casparser.in](mailto:sameer@casparser.in) for enterprise inquiries.
</Accordion>

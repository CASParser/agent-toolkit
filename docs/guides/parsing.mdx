...
|--------|--------|----------|----------|
| **CDSL** | eCAS from www.cdslindia.com/cas/logincas.aspx | Encrypted PAN | All holdings (CDSL + NSDL) |
| **NSDL** | eCAS from nsdlcas.nsdl.com/ecas/ecas.php | Encrypted PAN | All holdings (NSDL + CDSL) |

---
title: CAS Generator
description: Request CAS statements programmatically via KFintech email mailback. Get 50+ years of portfolio history.
---

## Overview

CAS Generator triggers KFintech to email a CAS statement to your user — no manual portal visits needed.
...
| **Data source** | CDSL demat only | CAMS + KFintech MF |
| **History** | Current holdings | 50+ years transactions |
| **User input** | PAN + DOB + OTP | Email + PAN |
